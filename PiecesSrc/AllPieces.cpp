...
std::vector<chess_move_t> AllPieces::allPossibleBlack(chess_piece_t const& piece, chess_board_t const& board) {
...
std::vector<chess_move_t> AllPieces::allPossibleWhite(chess_piece_t const& piece, chess_board_t const& board) {
